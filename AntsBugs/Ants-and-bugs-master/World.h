...
const int WORLDSIZE_X = 60; //Length of the world
const int WORLDSIZE_Y = 20; //HEight of the world

// Number of initial ants
const int INITIAL_ANTS = 30;

// Number of initial bugs
const int INITIAL_BUGS = 60;

//Number of initial Twins
const int INITIAL_TWINS = 12;

//Number of initial Rocks
const int INITIAL_ROCKS = 15;
...
//Holds the x y values for a location to be used in the world
struct Position
{
    int x;
    int y;
...
class World
{
    public:
		...
		//Checks every space in the map to, returns false if there is a space empty
		//otherwise true
		bool isFull();
    ...
    private:
        ...
        Organism* grid[WORLDSIZE_X][WORLDSIZE_Y];
